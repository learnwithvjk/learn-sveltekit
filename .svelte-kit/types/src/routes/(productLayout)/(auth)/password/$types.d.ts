...
type RouteParams = {  }
type RouteId = '/(productLayout)/(auth)/password';
...
type LayoutRouteId = RouteId | "/(productLayout)/(auth)/password/forgot" | "/(productLayout)/(auth)/password/info" | "/(productLayout)/(auth)/password/reset"
